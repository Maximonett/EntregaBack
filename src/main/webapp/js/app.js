...
{
    fetch('http://localhost:8080/FinalBack24116/pages/peliculas/', 
        {
        method: 'POST',
        headers: {
...
function loadItems() {
  ...
  {
    fetch(`http://localhost:8080/FinalBack24116/pages/peliculas/${id}`, 
        {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
...
{
      fetch(`http://localhost:8080/FinalBack24116/pages/peliculas/${data.id}`, 
        {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
